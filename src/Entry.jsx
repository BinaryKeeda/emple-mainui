...
//   const UserFinance = React.lazy(() => import("./view/user/finance"));
// const UserTransactions = React.lazy(() => import("./view/user/Transactions"));
...
//   const UserCodingProblems = React.lazy(
//     () => import("./view/user/ProblemList"),
//   );
...
//                 <Route
//                   path="/campus-admin"
//                   element={<ExternalRedirect url={ADMIN_URL} />}
//                 />
//                 <Route
...
const App = () => {
  ...
  const UserLayout = React.lazy(() => import("./view/user/Userdashboard"));
  const UserDashboard = React.lazy(() => import("./view/user/Dashboard"));
  const UserAssociatedGroup = React.lazy(() => import("./view/user/AssociatedGroup"));
  const UserPractice = React.lazy(() => import("./view/user/QuizOptions"));
  const UserResources = React.lazy(() => import("./view/user/ResourcesArea"));
  const UserCoding = React.lazy(() => import("./view/user/DsaSheet"));
  const UserCodingDescription = React.lazy(() => import("./view/user/components/ProblemsetDescription"));
  const UserBlog = React.lazy(() => import("./view/user/Blog"));
  ...
  const UserCodingProblemsAttempt = React.lazy(() => import("./view/user/ProblemAttempt"));
  const UserTestList = React.lazy(() => import("./view/user/TestList"));
  const UserTestAttempt = React.lazy(() => import("./view/user/TestAttemptPage"));
  const UserTestOptions = React.lazy(() => import("./view/user/TestOptions"));
  const UserQuizList = React.lazy(() => import("./view/user/QuizList"));
  const UserSolutionsList = React.lazy(() => import("./view/user/UserSolutionList"));

  // Admin routes
  const AdminLayout = React.lazy(() => import("./view/admin/pages/Admindashboard"));
  const Users = lazy(() => import("./view/admin/pages/Users"));
  const EditQuiz = lazy(() => import("./view/admin/pages/EditQuiz"));
  const CoinsAdd = lazy(() => import("./view/user/CoinsAdd"));
  const CoinsCheckout = lazy(() => import("./view/user/CoinCheckout"));
  ...
  const AdminTestListing = lazy(() => import("./view/admin/pages/AdminTests"));
  const AdmintCampusTestListing = lazy(() => import("./view/admin/pages/AdminCampusTest"));
  const AdminProblemsListing = lazy(() => import("./view/admin/pages/AdminProblems"));
  const AdminQuestionBankListing = lazy(() => import("./view/admin/pages/AdminQuestionBank"));
  const AdminEditTest = lazy(() => import("./view/admin/pages/AdminEditTest"));
  const AdminEditQuiz = lazy(() => import("./view/admin/pages/AdminEditQuiz"));
  const AdminEditCampusTest = lazy(() => import("./view/admin/pages/AdminEditCampusTest"));
  const AdminEditProblem = lazy(() => import("./view/admin/pages/AdminEditProblem"));
  const AdminEditQuestionBank = lazy(() => import("./view/admin/pages/AdminEditQuestionBank"));
  const AdminMailTest = lazy(() => import("./view/admin/pages/AdminMailTest"));

  // ✅ FIX 2: Added "return" keyword — this was missing and caused nothing to render!
  return (
    <HelmetProvider>
      <ThemeProvider>
        <SnackbarProvider
              ...
              <Routes>
                ...
                <Route path="/" element={<UserLayout />}>
                  ...
                  <Route
                    ...
                    element={<UserCodingDescription />}
                  />
                  <Route path="/user/binarykeeda-210-sheet" element={<UserRoadMapSheet />} />
                  <Route path="user/problems" element={<UserCodingProblems />} />
                  <Route path="user/binarykeeda-roadmap-sheet" element={<UserRoadmaps />} />
                  <Route path="user/blog" element={<UserBlog />} />
                  <Route path="user/binarykeeda-roadmap-sheet/blog/:slug" element={<UserBlog />} />
                ...
                >
                  ...
                  <Route path="roadmaps" element={<UserRoadmaps />} />
                  <Route path="profile" element={<UserProfile />} />
                  {/* ✅ FIX 3: Correct component name UserAIInterview (was AIInterview) */}
                  <Route path="interview" element={<UserAIInterview />} />
                 
                  <Route path="solutions/list/:slug" element={<UserSolutionsList />} />
                  <Route element={<UserTestOptions />} path="test-series/" />
                  <Route element={<UserTestList />} path="test-series/:id" />
                  <Route element={<UserPreview />} path="preview/:id" />
                ...
                <Route path="user/problem/:slug" element={<UserCodingProblemsAttempt />} />
                {/* ============================================================= */}
                {/*                        User Routes Ends                       */}
                {/* ============================================================= */}
                ...
                >
                  ...
                  <Route path="edit/campustest/:id" element={<AdminEditCampusTest />} />
                  <Route path="problems" element={<AdminProblemsListing />} />
                  <Route path="edit/problems/:id" element={<AdminEditProblem />} />
                  <Route path="users" element={<></>} />
                  <Route path="quiz" element={<AdminQuizListing />} />
                  <Route path="edit/quiz/:id" element={<AdminEditQuiz />} />
                  <Route path="questionbank" element={<AdminQuestionBankListing />} />
                  <Route path="edit/questionbanks/:id" element={<AdminEditQuestionBank />} />
                  <Route path="mail/:testId" element={<AdminMailTest />} />
                  <Route path="groups" element={<AdminGroupsManage />} />
                  <Route path="sections" element={<></>} />
                </Route>
                ...
                <Route path="/campus-superadmin" element={<ExternalRedirect url={ADMIN_URL} />} />
                <Route path="*" element={<NotFound />} />
              </Routes>
            </BrowserRouter>
          </Suspense>
