...
export default function App() {
  ...
  // ✅ NEW: Finance and Transactions
  const UserFinance = lazy(() => import("./view/user/finance"));
  const UserTransactions = lazy(() => import("./view/user/transaction"));
  const UserJobs = lazy(() => import("./view/user/jobs"));
        ...
        <Routes>
          <Route element={<AuthGuard />}>
            ...
            <Route path="/user" element={<UserLayout />}>
              ...
              <Route path="profile" element={<UserProfile />} />
              <Route path="interview" element={<UserAIInterview />} />
              {/* ✅ NEW: Finance and Transactions routes added here */}
            ...
            <Route path="/campus-admin" element={<ExternalRedirect redirect="/campus-admin" />} />
            <Route path="/campus-superadmin" element={<ExternalRedirect redirect="/campus-superadmin" />} />
