...
export default function App() {
    ...
    const UserAssociatedGroup = lazy(
    ...
    const UserCodingProblems = lazy(
        () => import("./view/user/ProblemList"),
    );
    const UserCodingProblemsAttempt = lazy(() => import("./view/user/ProblemAttempt"))
    const UserTestList = lazy(() => import("./view/user/TestList"));
    const UserTestAttempt = lazy(
