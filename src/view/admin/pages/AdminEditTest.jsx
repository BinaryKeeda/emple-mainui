...
//   const handleOpenProblemModal = (sectionId) => setOpenProblemModal(sectionId)
//   const handleCloseProblemModal = () => setOpenProblemModal(null)

//   const handleOpenQuestionModal = (sectionId) => setOpenQuestionModal(sectionId)
//   const handleCloseQuestionModal = () => setOpenQuestionModal(null)

//   useEffect(() => {
//     const fetchTest = async () => {
//       try {
//         const res = await axios.get(`${BASE_URL}/api/admin/tests/${testId}`, {
...
//       Type: {section.sectionType == "Quiz" ? "Quiz Questions " +
//         `${section.questionSet?.length} `: "Coding Problems " +  `${section?.problemset?.length}` }
//     </Typography>
...
//       {openQuestionModal === section._id && section.sectionType === 'Quiz' && (
//         <AddQuestionModal
//           open={true}
...
//       {openProblemModal === section._id && section.sectionType === 'Coding' && (
//         <AddProblemModal
//           open={true}
...
const AddQuestionModal = lazy(() =>
  import('../modals/AddTestSectionQuestionsModal')
)
                    ...
                    <ul className='list-disc ml-6 space-y-2 text-sm text-gray-800'>
                      {section.questionSet.map((q, i) => (
                        <li key={q._id || i}>
                          ...
                          <br />
                          <span className='text-gray-600'>Type:</span> {q.category}
                          <br />
                          {q.difficulty && (
                            <>
