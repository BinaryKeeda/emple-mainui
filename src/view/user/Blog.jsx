...
const BlogLayout = () => {
  ...
  // If no slug provided, show blog listing placeholder
  if (!slug) {
    return (
      <div className='p-10'>
        <h1 className='text-3xl font-bold mb-4'>Blog</h1>
        <p className='text-gray-600'>Blog listing will be added here.</p>
      </div>
    )
  }

  // If slug provided but blog not found yet
  if (!blog) return <div className='p-10'>Loading...</div>
  ...
  return (
    <section className=''>
      <Helmet>
        ...
        <link
          rel='canonical'
          href={`https://binarykeeda.com/blog/${slug}`}
        />
      </Helmet>
      <section className='mx-auto px-4  md:px-6 lg:px-8 mt-8 pb-0'>
        <p className='uppercase text-xs tracking-wide text-orange-500 font-semibold mb-2'>
