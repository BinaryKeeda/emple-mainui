...
export default function CodeEditor ({ setSubmitting, problem }) {
  ...
  const { testResponse, currSection, setProblemsSolved } = useTest()
  ...
  return (
    <div className='h-[calc(100vh-60px)] overflow-hidden'>
      <div className='h-[47px] flex justify-between px-4 items-center gap-2 p-2 border-b w-full shadow-sm mb-1'>
        <select
        ...
        <div className='flex gap-2'>
          <button
            className='flex items-center rounded-md border border-slate-300 py-2 px-4 text-sm shadow-sm hover:shadow-lg text-slate-600 hover:text-white hover:bg-slate-800 hover:border-slate-800'
      ...
      <div className='py-2'>
        <Editor
          ...
          theme='vs-light'
          height='calc(100vh - (60px + 47px + 16px))'
        />
      </div>
      <Modal
        open={showConfirmBox}
      ...
      >
        ...
        >
          ...
          <div className='flex shrink-0 flex-wrap items-center pt-4 justify-end'>
            ...
            <button
              onClick={() => runCode(language, code, true)}
              data-dialog-close='true'
