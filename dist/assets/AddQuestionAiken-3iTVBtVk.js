import{r as A,j as e,I as N,C as E,d as b,B as v}from"./index-SIXkfFwE.js";import{u as C}from"./index-B-EH3-QG.js";import{B as S}from"./Button-CsFkzLaw.js";function k(j){const x=j.split(/\r?\n/).map(s=>s.trim()).filter(s=>s.length>0),u=[];let l=[],n=[],m=1,d=0,h=null;const c=()=>{if(l.length===0)return;const s=l.join(`
