import{x as l,an as j,ao as N,ap as f,aq as i,ar as y,as as w,at as v,d as P,B as $,a as k,u as h,j as e,L as S,b as T,i as L,r as I,au as q,av as F}from"./index-Cw-TTt2Q.js";import"./TestProvider-B0Apyu-B.js";import{L as C}from"./Lock-wMPm_IIb.js";import"./useQuery-BeWBS4Cp.js";const p=async()=>{var o;const{page:r,category:s}=l.getState().testUser,c=(o=l.getState().auth.user)==null?void 0:o._id;l.dispatch(j());try{const a=(await E({page:r,category:s,userId:c,limit:20,search:""})).data.data.getTests;l.dispatch(N({key:a.page,value:a.data})),l.dispatch(f(a.totalPages)),l.dispatch(i(a.page)),l.dispatch(y()),a.totalPages<=r&&l.dispatch(w())}catch(t){l.dispatch(v(t.message)),console.log(t)}},E=async({page:r,limit:s,search:c,category:o,userId:t})=>{try{return await P.post(`${$}/graphql`,{query:`#graphql
                query GetTests (
                    $page: Int = 1,
                    $limit: Int = 10,
                    $search: String,
