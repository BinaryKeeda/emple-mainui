import{r as A,j as e,I as N,C as E,d as b,B as v}from"./index-B9lI-E5Z.js";import{u as C}from"./index-CQnvcOxk.js";import{B as S}from"./Button-ec8HoK58.js";function k(j){const x=j.split(/\r?\n/).map(s=>s.trim()).filter(s=>s.length>0),u=[];let l=[],n=[],m=1,d=0,h=null;const c=()=>{if(l.length===0)return;const s=l.join(`
