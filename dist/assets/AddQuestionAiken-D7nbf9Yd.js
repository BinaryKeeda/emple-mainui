import{r as A,j as e,I as N,C as E,d as b,B as v}from"./index-D-BX825n.js";import{u as C}from"./index-pM2NPJ9r.js";import{B as S}from"./Button-j4t6CXUy.js";function k(j){const x=j.split(/\r?\n/).map(s=>s.trim()).filter(s=>s.length>0),u=[];let l=[],n=[],m=1,d=0,h=null;const c=()=>{if(l.length===0)return;const s=l.join(`
