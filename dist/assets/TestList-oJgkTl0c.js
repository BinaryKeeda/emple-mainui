import{y as l,ap as j,aq as N,ar as f,as as i,at as y,au as w,av as v,b as P,B as $,c as k,u as h,j as e,L as S,a as T,i as L,r as I,aw as q,ax as F}from"./index-Dgxf8jnM.js";import"./TestProvider-BR1kzTrh.js";import{L as C}from"./Lock-jgb2ameN.js";import"./useQuery-BDnMhDTj.js";const p=async()=>{var o;const{page:r,category:s}=l.getState().testUser,c=(o=l.getState().auth.user)==null?void 0:o._id;l.dispatch(j());try{const a=(await E({page:r,category:s,userId:c,limit:20,search:""})).data.data.getTests;l.dispatch(N({key:a.page,value:a.data})),l.dispatch(f(a.totalPages)),l.dispatch(i(a.page)),l.dispatch(y()),a.totalPages<=r&&l.dispatch(w())}catch(t){l.dispatch(v(t.message)),console.log(t)}},E=async({page:r,limit:s,search:c,category:o,userId:t})=>{try{return await P.post(`${$}/graphql`,{query:`#graphql
                query GetTests (
                    $page: Int = 1,
                    $limit: Int = 10,
                    $search: String,
