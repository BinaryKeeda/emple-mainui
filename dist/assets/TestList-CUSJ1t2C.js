import{X as l,ar as j,as as N,at as f,au as i,av as y,aw as w,ax as v,d as P,B as $,a as k,u as h,j as e,L as S,b as T,i as L,r as I,ay as F,az as q}from"./index-Bxv2XW7s.js";import"./TestProvider-Bgrbw8Yv.js";import{L as C}from"./Lock-CePT1Gxv.js";const p=async()=>{var o;const{page:r,category:t}=l.getState().testUser,c=(o=l.getState().auth.user)==null?void 0:o._id;l.dispatch(j());try{const a=(await E({page:r,category:t,userId:c,limit:20,search:""})).data.data.getTests;l.dispatch(N({key:a.page,value:a.data})),l.dispatch(f(a.totalPages)),l.dispatch(i(a.page)),l.dispatch(y()),a.totalPages<=r&&l.dispatch(w())}catch(s){l.dispatch(v(s.message)),console.log(s)}},E=async({page:r,limit:t,search:c,category:o,userId:s})=>{try{return await P.post(`${$}/graphql`,{query:`#graphql
                query GetTests (
                    $page: Int = 1,
                    $limit: Int = 10,
                    $search: String,
