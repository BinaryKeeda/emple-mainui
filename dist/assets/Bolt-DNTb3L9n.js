import{v as C,w as b,r as w,x as k,j as d,y as x,z as S,A as R,an as $,ao as M,ap as u,aq as m,e as U}from"./index-B_WPkkw_.js";function A(t){return String(t).match(/[\d.\-+]*\s*(.*)/)[1]||""}function B(t){return parseFloat(t)}function j(t){return C("MuiSkeleton",t)}b("MuiSkeleton",["root","text","rectangular","rounded","circular","pulse","wave","withChildren","fitContent","heightAuto"]);const X=t=>{const{classes:e,variant:a,animation:n,hasChildren:s,width:i,height:o}=t;return R({root:["root",a,n,s&&"withChildren",s&&!i&&"fitContent",s&&!o&&"heightAuto"]},j,e)},r=m`
  0% {
    opacity: 1;
  }
