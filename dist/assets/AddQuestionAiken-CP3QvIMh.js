import{r as A,j as e,I as N,C as E,d as b,B as v}from"./index-BCJdd4xs.js";import{u as C}from"./index-Bzu0g9T-.js";import{B as S}from"./Button-CLlfYHVl.js";function k(j){const x=j.split(/\r?\n/).map(s=>s.trim()).filter(s=>s.length>0),u=[];let l=[],n=[],m=1,d=0,h=null;const c=()=>{if(l.length===0)return;const s=l.join(`
